                               ...
                               <!--  <div class="product-comments">
                                ...
                                <?php 
                                    ...
                                    if(!empty($data['product']->discount_amount ) && ($data['product']->discount_amount !=0 ) && ($data['product']->is_active == 'Y') && ($data['product']->expiry >= $date )){
                                        ...
                                        echo '<span class="price">'.number_format($disc_price, 2).'</span>';
                                        echo '<span class="old-price">'.number_format($old_price, 2).'</span>';
                                        echo '<span class="discount">'.$discount.'</span>';
                                    }else{
                                        echo '<span class="price">'.number_format($data['product']->price, 2).'</span>';
                                    }
                                ?>
                                </div>
                                <?php
                                ...
                                <div class="info-orther">
                                    ...
                                    <p>Availability: <span class="in-stock" id="in-stock">{{ $data['product']->quantity }}</span></p>
                                    <p>Condition: New</p>
                                </div>
...
<script type="text/javascript" src="{{ url('theme/frontend/default/assets/js/detail.js')}}"></script>
