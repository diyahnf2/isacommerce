                        ...
                        <ul class="products-block best-sell">
                                <li>
                                    <div class="products-block-left">
                                        <a href="#">
                                            <img src="{{ url('theme/frontend/default/assets/data/product-100x122.jpg')}}" alt="SPECIAL PRODUCTS">
                                        </a>
                                    </div>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{ url('theme/frontend/default/assets/data/product-260x317.jpg')}}" />
                                        </a>
                        ...
                        <div class="primary-box row">
                            <div class="pb-left-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-image">
                                    <div class="product-full">
                                        <img id="product-zoom" src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-s3-850x1036.jpg')}}"/>
                                    </div>
                                    <div class="product-img-thumb" id="gallery_01">
                                        <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false" data-margin="20" data-loop="false">
                                            <li>
                                                <a href="#" data-image="{{ url('theme/frontend/default/assets/data/product-s3-420x512.jpg')}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-s3-850x1036.jpg')}}">
                                                    <img id="product-zoom"  src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="{{ url('theme/frontend/default/assets/data/product-s2-420x512.jpg')}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-s2-850x1036.jpg')}}">
                                                    <img id="product-zoom"  src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="{{ url('theme/frontend/default/assets/data/product-420x512.jpg')}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-850x1036.jpg')}}">
                                                    <img id="product-zoom"  src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="{{ url('theme/frontend/default/assets/data/product-s4-420x512.jpg')}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-s4-850x1036.jpg')}}">
                                                    <img id="product-zoom"  src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="{{ url('theme/frontend/default/assets/data/product-s5-420x512.jpg')}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-s5-850x1036.jpg')}}">
                                                    <img id="product-zoom"  src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="{{ url('theme/frontend/default/assets/data/product-s6-420x512.jpg')}}" data-zoom-image="{{ url('theme/frontend/default/assets/data/product-s6-850x1036.jpg')}}">
                                                    <img id="product-zoom"  src="{{ url('theme/frontend/default/assets/data/product', [$data['product']->image])}}" /> 
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-price-group">
                                    <span class="price">{{number_format($data['product']->price, 2)}}</span>
                                    <span class="old-price">{{number_format($data['product']->price*1.3, 2)}}</span>
                                ...
                                <div class="form-action">
                                    <div class="button-group">
                                        <a class="btn-add-cart" href="{{ url('buy/'.$data['product']->product_seo) }}">Add to cart</a>
                                    </div>
                                    <div class="button-group">
