                                ...
                                <ul class="tree-menu">
                                    @foreach($data['category'] as $c)
                                        @if($c->parent_id == $data['title_1']->id)
                                            @if($c->id == $data['title_2']->id)
                                                <li class="active">
                                            @else
                                                <li>
                                            @endif
                                            <span></span><a href="{{ url('c/'.$data['title_1']->category_seo.'/'.$c->category_seo)}}">{{ $c->category_name }}</a>
                                            <ul class="tree-menu">
                                                @foreach($data['category'] as $ca)
                                                    @if($ca->parent_id == $c->id)
                                                        <li><span></span><a href="{{ url('c/'.$data['title_1']->category_seo.'/'.$c->category_seo.'/'.$ca->category_seo)}}">
                                                        {{ $ca->category_name }}</a>
                                                    @endif
                                                    </li>
                                                @endforeach
                    ...
                    <div class="block_content">
                        ...
                        <div class="layered layered-filter-price">
                            ...
                            <div class="layered-content slider-range">
                                <form method="post" action="{{ url('c/filter_2') }}" name="priceForm_1">
                                {{ csrf_field() }}
                            ...
                            <div class="layered-content slider-range">
                                ...
                                <form method="post" action="{{ url('c/filter_2') }}" name="priceForm_2">
                                {{ csrf_field() }}
                                <input type="hidden" name="seo_1" value="{{ $data['title_1']->category_seo }}"/> 
                                <input type="hidden" name="seo_2" value="{{$data['title_2']->category_seo}}"/> 
                                    <ul class="check-box-list">
...
<script type="text/javascript" src="{{ url('theme/frontend/default/assets/js/filter-category-2.js')}}"></script>
