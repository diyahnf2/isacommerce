            ...
            <div class="order-detail-content">
                    ...
                    <tbody>
                            <tr>
                                <td class="cart_product">
                                    <a href="#"><img src="{{ url('theme/frontend/default/assets/data/product-100x122.jpg')}}" alt="Product"></a>
                                </td>
                                <td class="cart_description">
                                    <p class="product-name"><a href="#">xcv</a></p>
                                    <small class="cart_ref">SKU : 1</small><br>
                ...
                <div class="cart_navigation">
                    ...
                    @if (session()->has('user_id'))
                        <a class="next-btn" href="{{ url('checkout/address') }}">Proceed to checkout 1</a>
                    @else
                        <a class="next-btn" href="{{ url('checkout/login') }}">Proceed to checkout 2</a>
                    @endif
