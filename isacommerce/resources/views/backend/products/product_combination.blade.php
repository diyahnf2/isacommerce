<!DOCTYPE html>
<!-- 
Template Name: Web Dev - Responsive Admin CMS build with Twitter Bootstrap 3.3.6
Version: 1.0.0
Author: Ismail Saleh
Website: http://www.idesolusiasia.com/
-->
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Web Dev | Custom Dropdowns</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"> Ale </span>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="ui_alerts_api.html" class="nav-link ">
                                        <span class="title">Web Dev Alerts API</span>
                                    </a>
                                </li>
                                <li class="nav-item  ">
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Ale Larson</h4>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; Web Dev by PT. Ide Solusi Asia.
