            ...
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form method="post" action="{{ url('/isa-cms/products/store-picture') }}" enctype="multipart/form-data">
                                        ...
                                        <section class="grid-wrap">
                                            <ul class="grid">
                                                @foreach($pictures as $p)
                                                    <li>
                                                        <figure>
                                                            <img src="{{ url('theme/backend/images/product',[$p->image]) }}" alt="img"/>
                                                            <figcaption>
                                                                <a role="button" class="btn btn-danger btn-block" href="#" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ url('/isa-cms/products/delete-picture',[$p->id]) }}">Remove</a>
                                                            </figcaption>
                                                        </figure>
                                                    </li>
                                                @endforeach
