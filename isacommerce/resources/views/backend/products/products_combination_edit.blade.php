            ...
            <div class="page-title">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ url('/isa-cms/products/combination/list',[$data['parent_id']]) }}">Combinations</a></li>
            ...
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form method="post" action="{{ url('/isa-cms/products/combination/update') }}" name="formCombination">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="id" value="{{ $data['id'] }}" />
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h3 class="panel-title">Edit Combination</h3>
                                </div>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="tab1">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="values" class="form-control" id="values">
                                                    ...
                                                    <div class="form-group{{ $errors->has('attrVal') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select multiple class="form-control" name="attrVal[]" id="attrVal">
                                                                @foreach($data['value_pair'] as $v)
                                                                    <option value= "{{$v->attribute_id}}|{{$v->value_id}}"> {{ $v->attribute_name }} : {{ $v->value_name }} </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="tab2">
                                                <?php $discount_id = (!empty($data['product']->discount->id) ? $data['product']->discount->id : '-'); ?>
                                ...
                                <div class="panel-footer">
                                    ...
                                    <a class="btn btn-danger btn-space" href="{{ url('/isa-cms/products/combination/list',[$data['parent_id']]) }}">Cancel</a>
