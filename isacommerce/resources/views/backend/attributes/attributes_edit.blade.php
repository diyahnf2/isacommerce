            ...
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form method="post" action="{{ url('/isa-cms/attributes/update') }}">
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                            <input type="hidden" name="id" value="{{ $attribute->id }}">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Edit Attribute</h4>
                                </div>
                                <div class="panel-body form-horizontal">
                                    ...
                                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="description" required>{{ $attribute->description }}</textarea>
