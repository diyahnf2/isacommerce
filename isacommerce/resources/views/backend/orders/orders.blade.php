                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div aria-label="Justified button group" role="group" class="btn-group btn-group-justified">
                                                            @if(Auth::guard('admin')->user()->can('orders-detail'))
                                                                <a role="button" class="btn btn-info" href="{{ url('/isa-cms/orders/detail',[$o->id]) }}" data-toggle="tooltip" data-placement="top" title="Detail Orders"><i class="fa fa-calculator" aria-hidden="true"></i></a>
                                                            @endif
                                                            @if(Auth::guard('admin')->user()->can('orders-delete'))
                                                                <a role="button" class="btn btn-danger" href="#" data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ url('/isa-cms/orders/delete',[$o->id]) }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                            @endif
                                                        </div>
                                                    </td>
                                                </tr>
