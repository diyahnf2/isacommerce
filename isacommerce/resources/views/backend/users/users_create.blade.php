                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body form-horizontal">
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="name" value="{{ old('category_name') }}" required>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="email" value="{{ old('category_name') }}" required>
                                            @if ($errors->has('email'))
                                                <span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="password" value="{{ old('category_name') }}">
